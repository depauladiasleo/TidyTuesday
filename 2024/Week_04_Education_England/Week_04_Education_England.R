...
## Texto -----------------------------------------------------------------------
  ...
  títulos <- list(título = "How do universities affect general educational score?",
                  subttítulo = "England's towns educational score as of 2011 according to the existence of universities", 
                  legenda = "Tidy Tuesday | 2024 | Week 04 | England's education |\nchart: @depauladiasleo | data: The UK Office for National Statistics",
                  y = "Educational\nscore")
  
  
  annotation <- tibble(x = 0, y = 10, label = "Although graphically different, Wilcoxon Rank Sum test\nprovides us a moderately significant difference\nbetween both groups (p-value: 0.1944).")
...
ggsave("Week_04_England_Education.png",
       width = 1800,
       height = 1012.5,
       units = "px",
       dpi = 110)
